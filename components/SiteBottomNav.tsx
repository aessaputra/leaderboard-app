...
export default function SiteBottomNav() {
  ...
  return (
    <nav className="mx-auto grid w-full max-w-md grid-cols-4 gap-6 py-3 px-10 sm:px-12 sm:max-w-3xl safe-px">
      {items.map(({ href, label, Icon }) => {
        ...
        const cls =
          'flex h-12 items-center justify-center rounded-xl border px-5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white ' +
          (active
